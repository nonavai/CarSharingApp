...
public interface IUserRepository 
{
    ...
    Task<IdentityResult> AddAsync(User entity, string password, CancellationToken token = default);
    Task<bool> CheckPasswordAsync(User entity, string password);
    Task<IEnumerable<string>> GetRolesAsync(User user);
    Task<IdentityResult> AddToRoleAsync(User user, string role);
    Task<IdentityResult> RemoveFromRolesAsync(User user, string role, CancellationToken token = default);
    ...
    Task<IdentityResult> DeleteAsync(User entity, CancellationToken token = default);
}